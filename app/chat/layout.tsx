...
export default function ChatLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-[calc(100vh-80px)] bg-white border-t border-gray-200" dir="rtl">
      ...
      <div className="w-full md:w-1/3 lg:w-1/4 border-l border-gray-200 bg-white overflow-y-auto">
      ...
      {/* منطقة عرض المحادثة النشطة (children) */}
      <div className="hidden md:block md:w-2/3 lg:w-3/4 bg-[#efeae2] relative">
        {children}
      </div>
    </div>
  );
