...
export default function ChatWindow({ roomId }: { roomId: string }) {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#efeae2]" dir="rtl">
      {/* منطقة الرسائل */}
      ...
      {/* مربع الكتابة - تم التعديل هنا لحمايته من الاختفاء */}
      <div className="shrink-0 w-full bg-white border-t border-gray-200">
